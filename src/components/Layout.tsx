...
export const Layout = async ({ children }: { children: ReactNode }) => {
  ...
  return (
    <div className="flex flex-col min-h-[100vh]">
      ...
      <main
        className={cn(
          'prose prose-basic prose-code:text-[#e95a00] prose-code:bg-[#2d2d2d] prose-code:before:content-none prose-code:after:content-none prose-code:px-0.5 prose-code:py-1 prose-h2:mt-0',
